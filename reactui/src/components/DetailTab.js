...
class DetailTab extends Component {
  constructor(props) {
    ...
    var url =
      "https://api.popcorntales.com/image?object=Graph/" +
      this.props.movie.title +
      ".png&width=400&height=400";
    var cast = this.props.movie.cast;
    var ticketImage =
      "https://api.popcorntales.com/image?object=" +
      this.props.movie.ticketDetails.ticketImage;
    this.state = {
      pros: pros,
      cons: cons,
      url: url,
      ...
      <div className="movie-detail">
        <Collapse accordion="true" defaultActiveKey={["1"]}>
          ...
          <Panel header="Ticket" key="5" style={{ textAlign: "justify" }}>
            <Suspense>
              <Ticket
                ticketDetails={this.state.movie.ticketDetails}
